...
<del>3. система забезпечення банківської діяльності (банк, клієнти, менеджери, рахунки, платежі тощо)</del>  
...
<del>2. [Eclipse Papyrus](https://www.eclipse.org/papyrus/)</del>  
<del>3. [UML plugins for IntelliJ Idea](https://plugins.jetbrains.com/search?search=UML) - на жаль, тут все досить погано😒</del>  
<del>4. [StarUML](http://staruml.io/)</del>  
<del>5. [GenMyModel](http://www.genmymodel.com/) - онлайновий сервіс, раджу познайомитись з ним ближче!</del>

## Інформація про виконане завдання

Була створена діаграма класів для керування закладом громадського харчуаання, в якій показано як об'єкти взаємодіють один з одним.

![Class Diagram](other/classDiagram.png)
